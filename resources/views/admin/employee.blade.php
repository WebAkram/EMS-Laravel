...
@section('content')
    ...
    <div style="margin-right: 25px;" class="float-end  container-fluid">
        <div class="alert alert-success shadow-md border text-danger fw-bolder text-center alert-dismissible fade"
            role="alert">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group mt-2">
                                    ...
                                    <select id="upstatus" class="form-control fw-bold text-dark">
                                        <option  class="text-dark">
                                        </option>
...
<script>
    ...
    $(document).ready(function() {
        ...
        function getProducts(page) {
            $.ajax({
                    url: '/pagination/adminemployee?page=' + page,
    ...
    $(document).ready(function() {
        $(document).on('click', '#updateemployee', function() {
            ...
            let up_status = $(this).data('upstus');
            ...
            $('#updoi').val(up_doi);
            $('#updoe').val(up_doe);
            $('#upstatus').val(up_status);
            $('#updepartment').empty();
            $('#upstatus').empty();
            $('#upstatus').append($('<option>', {
                class: 'd-none',
                text: up_status,
                value: up_status
            }));
             // Add the additional options with the specified attributes
             $('#upstatus').append($('<option>', {
                value: 'Decline',
                text: 'Decline'
            }));
