...
<head>
    ...
    <link href="{{ asset('dashboard/lib/tempusdominus/css/tempusdominus-bootstrap-4.min.css') }}"
        rel="stylesheet" />
...
@endif
                ...
                <div class="navbar-nav w-100">
                    <a href="{{ url('indexdashboard') }}" class="nav-item nav-link {{ Request::is('indexdashboard') ? 'active' : '' }}">
                        <i class="fa fa-tachometer-alt me-2"></i>Dashboard
                    </a>
                    <a href="{{ url('/department')}}" class="nav-item nav-link"><i
                            class="fa fa-bed me-2"></i>Department</a>
                    <a href="{{ url('/adminemployee')}}" class="nav-item nav-link"><i class="fa
                        fa-table me-2"></i>
                        Employee</a>
                     <a href="{{ url('/adminprofile') }}" class="nav-item nav-link"><i
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
                <a href="{{ url('/dashboard') }}" class="navbar-brand d-flex d-lg-none  mr-5">
                    <img class="rounded" src="{{ asset('dashboard/img/icon.png') }}" class="img" alt="Image"
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end bg-light border-0 rounded-0 rounded-bottom m-0">
                            <a href="{{ url('/adminprofile')}}" class="dropdown-item">My Profile</a>
